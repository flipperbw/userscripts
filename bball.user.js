// ==UserScript==
// @name          ESPN Fantasy Basketball Extras
// @author		  Flipperbw
// @version       1.51
//
...
function add_games(){
    ...
    if (window.location.pathname.split("/")[1] == 'fba') {
        ...
        var firstgame = new Date(2013,3,1);
        var mxweek = 26;
        var teamlist = ['LAA', 'BAL', 'BOS', 'CWS', 'CLE', 'DET', 'HOU', 'KC', 'MIN', 'NYY', 'OAK', 'SEA', 'TB', 'TEX', 'TOR', 'ARI', 'ATL', 'CHC', 'CIN', 'COL', 'MIA', 'LAD', 'MIL', 'NYM', 'PHI', 'PIT', 'SD', 'SF', 'STL', 'WSH'];
        var weeklist = {
            '1':[6,6,6,6,6,6,6,6,6,6,7,7,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6],
            '2':[6,6,6,6,7,6,6,6,6,7,6,7,6,7,6,6,6,7,6,6,6,6,6,6,6,6,6,7,6,6],
            '3':[6,6,7,7,6,6,6,5,6,6,6,6,7,6,7,6,6,6,7,7,7,6,6,7,7,7,6,6,7,6],
            '4':[7,7,7,7,6,6,7,6,6,7,7,7,7,7,7,7,6,7,7,7,6,6,6,6,7,7,6,6,6,7],
            '5':[7,7,6,6,6,7,7,7,6,6,6,6,6,6,6,6,7,7,6,6,7,6,7,6,6,6,7,6,7,7],
            '6':[6,6,7,5,7,5,6,6,7,6,7,5,7,5,7,7,7,5,6,6,6,6,5,6,7,6,6,7,5,5],
            '7':[7,5,6,7,5,7,6,6,6,6,6,6,6,7,5,6,6,6,6,7,6,6,7,7,5,7,6,6,7,7],
            '8':[6,7,7,6,7,6,6,7,7,6,6,6,6,6,7,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6],
            '9':[7,7,7,7,7,7,7,7,7,7,7,7,7,6,7,6,7,7,7,7,7,7,7,7,7,7,7,7,7,7],
            '10':[6,6,6,7,6,6,7,6,6,7,7,7,6,6,5,7,7,5,6,7,6,7,7,6,7,6,7,5,7,6],
            '11':[6,7,7,6,6,6,6,7,6,6,6,6,7,7,7,6,6,7,7,6,6,6,6,6,6,6,6,6,6,6],
            '12':[7,6,6,7,6,7,7,6,6,6,7,7,6,7,6,6,7,7,7,7,7,6,6,7,6,7,7,7,7,7],
            '13':[6,7,6,5,7,6,5,6,6,6,5,5,6,6,7,6,5,6,5,5,5,7,6,5,7,5,6,6,5,6],
            '14':[6,6,6,6,6,7,7,6,7,7,6,6,7,6,7,7,6,6,7,6,7,6,7,7,6,6,7,7,6,7],
            '15':[5,7,7,6,7,7,5,7,7,7,6,7,7,7,6,7,7,6,7,7,6,7,7,6,7,6,7,7,6,7],
            '16':[3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3],
            '17':[7,7,7,7,6,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,6,7,7,6,6,7],
            '18':[7,6,6,7,7,5,6,6,6,5,6,6,5,6,7,5,7,7,6,7,7,6,6,7,6,7,6,6,7,5],
            '19':[6,5,7,6,7,7,6,7,6,6,5,6,5,6,6,5,6,6,5,6,6,7,7,6,6,6,5,7,7,6],
            '20':[7,6,6,7,6,7,7,7,7,7,7,6,6,6,7,6,6,6,7,6,6,6,6,7,6,6,7,6,6,6],
            '21':[6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,7,6,7,7,7,7,7,6,5,7,7,6,7,7,7],
            '22':[6,6,6,6,6,7,7,6,6,6,7,7,6,6,6,6,6,6,6,6,6,6,6,7,7,6,6,6,6,6],
            '23':[7,7,7,7,6,6,7,7,6,7,7,7,7,6,6,7,6,6,7,6,6,6,6,6,6,6,6,7,7,6],
            '24':[6,7,6,7,7,6,6,6,6,7,6,6,6,6,6,6,7,7,6,6,7,7,6,7,6,7,6,7,6,7],
            '25':[6,6,6,6,7,7,7,6,7,6,7,7,7,7,6,7,6,7,6,7,7,7,7,6,6,7,7,6,7,7],
            '26':[7,7,5,6,6,6,6,7,7,6,6,6,7,7,6,7,7,6,6,5,6,6,7,7,7,6,7,6,6,6]
        };
    }

    var today = new Date();
    var currentweek = Math.ceil((today.getTime()-firstgame.getTime()) / (1000*60*60*24*7));
    var numweeks = 8;
